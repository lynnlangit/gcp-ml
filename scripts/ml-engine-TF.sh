...
# Builds a wide and deep model for predicting income category based on US Census Income Dataset
# The two income categories (or labels) are:
    # >50K—Greater than 50,000 dollars
    # <=50K—Less than or equal to 50,000 dollars

# Wide and deep models use deep neural nets (DNNs) to learn high level abstractions about complex 
